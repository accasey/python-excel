...
# Do this datatype casting for memory efficiency, i.e. the panda doesn't need to guess
# when initially loading for each column
# - useful for large files
df = pd.read_csv('crime.csv', encoding='utf-8',
                 dtype={"INCIDENT_NUMBER": str, "OFFENSE_CODE": str,
